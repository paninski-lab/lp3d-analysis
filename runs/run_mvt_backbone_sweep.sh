...
# Sweep over MVT backbones for ibl-mouse (multiview_transformer, no 3D loss)
# Each backbone trains 3 seeds and saves to Lightning Storage
#
# Usage:
#   ./run_mvt_backbone_sweep.sh                                    # All backbones on GPU 0
#   ./run_mvt_backbone_sweep.sh 1                                  # All backbones on GPU 1
#   ./run_mvt_backbone_sweep.sh 0 --backbones vitb_dino,vits_dinov2  # Specific backbones
...
PIPELINE_CONFIG="${CONFIG_DIR}/pipeline_inference_mvt_backbone_sweep_ibl-mouse.yaml"
LIGHTNING_CONFIG="${CONFIG_DIR}/config_ibl-mouse_mvt_backbone_sweep.yaml"
...
echo "=========================================="
echo "MVT Backbone Sweep - ibl-mouse (multiview_transformer)"
echo "=========================================="
...
for backbone in "${BACKBONES[@]}"; do
    COUNTER=$((COUNTER + 1))
    RESULTS_NAME="test_200_MVT_${backbone}"
...
for backbone in "${BACKBONES[@]}"; do
    echo "  test_200_MVT_${backbone}/"
    echo "    multiview_transformer_200_0/"
    echo "    multiview_transformer_200_1/"
    echo "    multiview_transformer_200_2/"
done
echo "=========================================="
