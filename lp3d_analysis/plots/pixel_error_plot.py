...
def plot_comparison(df_line2, n_points_dict, models_to_plot, color_mapping, percentiles=[95, 50, 5], figsize = (5,7), dataset_name = 'fly-anipose',std_vals = np.arange(0, 20, 0.5), ylim=None):
    ...
    model_colors = {
        ...
        'v0_5k_128_ensemble_median_2d_filters.0': 'hotpink',
    ...
    custom_labels = {
            ...
            'v0_5k_128_ensemble_median_2d_filters': 'Ensemble Median 2D Filters',
            'v0_5k_128_ensemble_median_temporal': 'Ensemble Median Temporal',
            'v0_5k_128_ensemble_median_spatial': 'Ensemble Median Spatial',
            'v0_5k_128_ensemble_median_spatiotemporal': 'Ensemble Median Spatiotemporal',
            'v0_5k_128_ensemble_median_2d_filters_updated': 'Ensemble Median All 2D Filters',
            'v0_5k_128_non_linear_eks_geometric': 'Non-linear EKS Geometric',
